...
<footer className="px-6 divide-y bg-Sheen_green-50 sm:p-6 dark:bg-gray-900 max-w-12xl mx-auto">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">REkart™</a>. All Rights Reserved.
        </span>
